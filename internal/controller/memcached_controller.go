...
import (
	...
	examplecomv1alpha1 "tylerjgabb/does-not-exist-yet/api/v1alpha1"
)

const memcachedFinalizer = "example.com.tyler.gabb.domain/finalizer"
...
//+kubebuilder:rbac:groups=example.com.tyler.gabb.domain,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=example.com.tyler.gabb.domain,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=example.com.tyler.gabb.domain,resources=memcacheds/finalizers,verbs=update
